...
*code already used for analysis in previous work, which was used to process trajectory data and calculate relevant distances. You can find those materials [here](https://github.com/TheSochaLab/FlyingSnakeGaps) and [here](https://github.com/TheSochaLab/DendrelaphisGaps.) \
